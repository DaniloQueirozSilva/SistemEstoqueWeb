...
namespace SistemaEstoqueWeb.Controllers
{
    public class ProdutoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoID,NomeProduto,NumeroSerie,Quantidade,Preço,UsuarioId")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoID,NomeProduto,NumeroSerie,Quantidade,Preço,UsuarioId")] Produto produto)
        {
